const diplomas = [
  {
    ...
    modules: ['AI and machine learning', 'Business Analysis', 'Business Intelligence'],
  ...
  },
  {
    ...
    modules: ['Business Intelligence', 'Front-End Web Development', 'Fundamentals of Design', 'Immersive Technologies', 'Mobile App Development', 'Software Testing and Analytics', 'UI/UX Design for Apps'],
  ...
  },
  {
    ...
    modules: ['Distributed Ledger Technologies', 'Distributed Ledger Technology Solutioning', 'Entrepreneurship', 'Enterprise Solutions for Business'],
  ...
  },
  {
    ...
    modules: ['Ethical Hacking', 'Digital Security and Forensics', 'Intelligent Networks', 'Internetworking Security'],
  ...
  },
  {
    ...
    modules: ['Intelligent Networks', 'Internetworking', 'Internet Server Technologies', 'IT Service Delivery'],
